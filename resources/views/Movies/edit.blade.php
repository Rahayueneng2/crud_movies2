...
<div class="container mx-auto my-10">
    <h1 class="text-3xl font-extrabold text-center mb-6">Edit Movie</h1>
    <form action="{{ route('movies.update', $movie->id) }}" method="POST" class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg p-8" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <input type="text" id="title" name="title" class="w-full p-3 border-2 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('title', $movie->title) }}" required>
        ...
        <!-- Current Poster (if exists) -->
        @if ($movie->poster)
            <div class="mb-6">
                <label class="block text-lg font-medium text-gray-700">Current Poster:</label>
                <img src="{{ asset('storage/posters/' . $movie->poster) }}" alt="Current Poster" class="w-32 h-32 object-cover mt-2">
            </div>
        @endif
        ...
        <div class="mb-6">
            ...
            <input type="text" id="year" name="year" class="w-full p-3 border-2 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('year', $movie->year) }}" required>
